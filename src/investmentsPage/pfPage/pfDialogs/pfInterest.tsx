...
const PFInterestDialog = ({ display, setDisplay }) => {
  const dialogRef = useRef(null)
  const pfInterestColumn: ColDef[] = [
    {
      headerName: 'Interest',
      field: 'interest',
    ...
    <>
      {display && (
        ...
        >
          ...
          >
            <AgGrid
              columnDefs={pfInterestColumn}
              rowData={pfCtx.pfData.pfInterest}
              width={'100'}
              height={'100'}
            />
          </div>
...
export default PFInterestDialog
